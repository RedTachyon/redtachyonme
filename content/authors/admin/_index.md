...
- icon: envelope
  icon_pack: fas
  link: 'mailto:ariel.j.kwiatkowski+rtme@gmail.com'  # For a direct email link, use "mailto:test@example.org".
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/RedTachyon
- icon: google-scholar
  icon_pack: ai
  link: https://scholar.google.com/citations?user=xkhji7MAAAAJ&hl=en
- icon: github
  icon_pack: fab
